...
export default function Compliance_verification() {
  ...
  return (
    <div>
        <div className="px-5 bg-zinc-100 p-6 rounded">
            <div className="flex justify-between items-center flex-wrap gap-3">
                <div className="w-full">
                    ...
                    <div className="mt-8 mon_navs text-gray-500 w-full font-medium flex items-center justify-start gap-5">
                        ...
                        <div className="">
                            <Link to={'/contract-management'} className=''>Contract management</Link>
                        </div>
                        <div className="">
                            <Link to={'/compliance-verification'} className='text-red-700'>Compliance verification</Link>
                        </div>
                    </div>
                </div>
            </div>
            <form onSubmit={handleSubmit} className="">
                <div className="mt-5 p-3 bg-white rounded-md">
                    <div className="border-b pb-5 gap-3 flex-wrap border-gray-300 flex justify-between items-center">
                        <div className="">
                            <h2 className='text-2xl font-medium'>Compliance Documents</h2>
                        </div>
                    ...
                    <div className="border-b border-gray-300  py-7 ">
                        <div className="md:w-[80%] w-full gap-7 flex justify-center flex-wrap">
                            <div className="md:w-[35%] w-[100%]">
                                ...
                                <p className="text-gray-500 font-medium">Upload supplier's ID card, Permits and all the necessary document for compliance verification.</p>
                            </div>
                                    ...
                                    !upload ? (
                                        <>
                                            ...
                                            <div className="mt-5 h-[70px] relative p-3 rounded-md w-full flex gap-3 justify-start border border-red-200">
                                                <div className="w-7 h-7 bg-red-100 rounded-full flex justify-center items-center" defaultValue={'21/11/2024'}>
                                        ...
                                        <>
                                            <div className="pb-4 w-full gap-3 flex text-gray-500 justify-start items-center">
                                                <div className="md:w-[48.5%]">
                                                    <p className="font-medium pb-3">Certificate name</p>
                                                    <input type="text" id="idcard" placeholder='I.D card' className='border border-gray-300 text-black outline-none font-medium rounded-md h-[45px] w-full px-4'/>
                                                </div>
                                                <div className="md:w-[48.5%]">
                                                    <p className="font-medium pb-3">Expiring date</p>
                                                    <input type="date" id="lastname" placeholder='Select' className='border border-gray-300 text-black outline-none font-medium rounded-md h-[45px] w-full px-4'/>
                                                </div>
                                            </div>

                                            <div className="mb-4 h-[60px] relative p-3 rounded-md w-full flex gap-3 justify-start border border-red-200">
                                                <div className="w-7 h-7 bg-red-100 rounded-full flex justify-center items-center" defaultValue={'21/11/2024'}>
                                                    <IoMdCopy className='text-red-800'/>
                                                </div>
                                                <div className="flex-1 pr-5">
                                                    <p className="text-sm font-medium">I.D card.pdf</p>
                                                    <p className="text-sm text-gray-500">200KB</p>
                                                </div>
                                                <div className="absolute top-3 right-3 text-gray-500">
                                                    <RiDeleteBinLine className='cursor-pointer'/>
                                            ...
                                            <div className="border-t border-b text-gray-500 w-full py-4 gap-3 flex justify-start items-center">
                                                <div className="md:w-[48.5%]">
                                                    <p className="font-medium pb-3">Certificate name</p>
                                                    <input type="text" id="certifcatename" placeholder='Work Permit' className='border border-gray-300 text-black outline-none font-medium rounded-md h-[45px] w-full px-4'/>
                                                </div>
                                                <div className="md:w-[48.5%]">
                                                    <p className="font-medium pb-3">Expiring date</p>
                                                    <input type="date" id="lastname" placeholder='Select' className='border border-gray-300 text-black outline-none font-medium rounded-md h-[45px] w-full px-4'/>
                                            ...
                                            <div className="my-4 h-[60px] relative p-3 rounded-md w-full flex gap-3 justify-start border border-red-200">
                                                <div className="w-7 h-7 bg-red-100 rounded-full flex justify-center items-center" defaultValue={'21/11/2024'}>
                                                    <IoMdCopy className='text-red-800'/>
                                                </div>
                                                <div className="flex-1 pr-5">
                                                    <p className="text-sm font-medium"> Permit.pdf</p>
                                                    <p className="text-sm text-gray-500">200KB</p>
                                                </div>
                                                <div className="absolute top-3 right-3 text-gray-500">
                                                    <RiDeleteBinLine className='cursor-pointer'/>
                                            ...
                                            <div className=" w-full gap-3 flex text-gray-500 justify-start items-center">
                                                <div className="md:w-[48.5%]">
                                                    <p className="font-medium pb-3">Certificate name</p>
                                                    <input type="text" id="certifcation" placeholder='Enter certifcation name' className='border border-gray-300 text-black outline-none font-medium rounded-md h-[45px] w-full px-4'/>
                                                </div>
                                                <div className="md:w-[48.5%]">
                                                    <p className="font-medium pb-3">Expiring date</p>
                                                    <input type="date" id="lastname" placeholder='Select' className='border border-gray-300 text-black outline-none font-medium rounded-md h-[45px] w-full px-4'/>
